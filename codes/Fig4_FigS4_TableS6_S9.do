	...
	use "$master/y_x_daily.dta", clear
		...
		*
		...
		reghdfe `i' inter_c_t ct_gdppc if year == 2020, absorb(i.dsp i.date) vce(cluster dsp)
			parmest, saving($results/fig4_tableS6_S9/hete_`i'__gdppc.dta, replace) 
			outreg2 using $results/fig4_tableS6_S9/hete_`i'.xls, replace se bracket dec(3) ///
		...
		reghdfe `i' inter_c_t ct_hospital_bed if year == 2020, absorb(i.dsp i.date) vce(cluster dsp)
			parmest, saving($results/fig4_tableS6_S9/hete_`i'__hospital_bed.dta, replace) 
			outreg2 using $results/fig4_tableS6_S9/hete_`i'.xls, append se bracket dec(3) ///
		...
		reghdfe `i' inter_c_t ct_pm25 if year == 2020, absorb(i.dsp i.date) vce(cluster dsp)
			parmest, saving($results/fig4_tableS6_S9/hete_`i'__pm25.dta, replace) 
			outreg2 using $results/fig4_tableS6_S9/hete_`i'.xls, append se bracket dec(3)  ///
		...
		reghdfe `i' inter_c_t ct_secondary_ratio if year == 2020, absorb(i.dsp i.date) vce(cluster dsp)
			parmest, saving($results/fig4_tableS6_S9/hete_`i'__secondary_ratio.dta, replace) 
			outreg2 using $results/fig4_tableS6_S9/hete_`i'.xls, append se bracket dec(3) ///
		...
		reghdfe `i' inter_c_t ct_`i' if year == 2020, absorb(i.dsp i.date) vce(cluster dsp)
			parmest, saving($results/fig4_tableS6_S9/hete_`i'__`i'.dta, replace) 
			outreg2 using $results/fig4_tableS6_S9/hete_`i'.xls, append se bracket dec(3) ///
...
* getting sd above/below the mean
		...
		tempname get
		cap erase $results/fig4_tableS6_S9/figdata.dta

		cap erase $results/fig4_tableS6_S9/figdata.dta
		postutil clear
		postfile `get' str20 x str20 y sd estimate ster p min95 max95 using $results/fig4_tableS6_S9/figdata.dta
...
* creating figure
		...
		*
		...
		graph save "$figures/fig4_figS4/fig4.gph", replace
		
		graph export "$figures/allfig_eps/fig4.eps", replace
		graph export "$figures/allfig_png/fig4.png", replace		
		...
		*
		...
		graph save "$figures/fig4_figS4/figS4_panelA.gph", replace
		restore	
		...
		graph save "$figures/fig4_figS4/figS4_panelB.gph", replace
		restore	
		...
		graph save "$figures/fig4_figS4/figS4_panelC.gph", replace
		restore	
				
		graph combine "$figures/fig4_figS4/figS4_panelA.gph" "$figures/fig4_figS4/figS4_panelB.gph" "$figures/fig4_figS4/figS4_panelC.gph", graphregion(fcolor(white) lcolor(white)) imargin(small) col(3) iscale(0.85)  xsize(8) ysize(6)
		graph save "$figures/fig4_figS4/figS4.gph", replace
			
		graph export "$figures/allfig_eps/figS4.eps", replace
		graph export "$figures/allfig_png/figS4.png", replace		
